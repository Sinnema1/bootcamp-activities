...
//checking the query parameters for a 'sort' and returning the data sorted if it exists

app.get('/api/terms/', (req: Request, res: Response) => {
  // TODO: Add a comment describing the req.query object
  //contains the query parameters (i.e. any key/value pair after the ?)

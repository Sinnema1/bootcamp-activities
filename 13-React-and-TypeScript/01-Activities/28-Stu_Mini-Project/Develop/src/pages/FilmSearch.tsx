...
const FilmSearch = () => {
  ...
  const searchForFilmByTitle = async (event: FormEvent<HTMLFormElement>, film_title: string) => {
  ...
  return (
    <>
      <section id='searchSection'>
        <form
          // Add correct type to event
          onSubmit={(event: FormEvent<HTMLFormElement>) => searchForFilmByTitle(event, searchInput)}
        >
          <input
            type='text'
            name=''

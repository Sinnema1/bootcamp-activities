...
def calculate_loan_balance(principal, monthly_payment=0, annual_interest_rate=5.99, years=1):
    ...
    for year in range(years):
        ...
        for month in range(12):
            ...
            principal = (
                principal * (1 + annual_interest_rate / 100 / 12) - monthly_payment
            )
...
if __name__ == "__main__":
    ...
    print("Calculate the balance of the loan after a different number of " + "years.")
    ...
    print(
        "The default interest rate is 5.99%."
    ...
    # Print the balance of the loan
    print(
        f"The balance of the loan with an interest rate of {interest}% "
